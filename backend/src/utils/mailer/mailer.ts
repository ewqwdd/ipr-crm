...
<p style="margin-left:30px;">Чтобы задать пароль, нажмите на кнопку "Задать пароль"</p>
      <a href="${process.env.FRONTEND_URL}/invite?code=${user.authCode}" style="display:inline-block;margin-top:20px;padding:10px 20px;background-color:#007bff;color:#fff;text-decoration:none;border-radius:5px;">Задать пароль</a>
      </div>
        `;
