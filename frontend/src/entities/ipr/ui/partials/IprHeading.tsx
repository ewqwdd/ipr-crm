  ...
  return (
    ...
    <Heading title="Индивидуальный план развития" />
        ...
        <div className="flex gap-4">
            <Avatar src={ipr?.user.avatar} className="size-12 rounded-md border-black/5 border" />
        </div>
        <div className="flex flex-col">
      <h1 className="text-lg leading-6 font-medium text-gray-900">{ipr?.user.firstName} {ipr?.user.lastName}</h1>
