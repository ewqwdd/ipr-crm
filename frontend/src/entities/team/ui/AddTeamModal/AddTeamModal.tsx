...
export default function AddTeamModal({ parentId, open, setOpen }: AddTeamModalProps) {
  ...
  return (
    <Modal open={!!open} setOpen={setOpen} loading={isLoading} title="Add Team" footer={false}>
