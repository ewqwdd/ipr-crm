...
export default forwardRef(function TextAreaWithLabel({ label, className, name, right, error, ...props }: TextareaWithLabelProps, ref: ForwardedRef<HTMLTextAreaElement>) {
    let labelElem
