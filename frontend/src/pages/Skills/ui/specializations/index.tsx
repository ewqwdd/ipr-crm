...
const SpecializationsWrapper: FC<SpecializationsWrapperProps> = ({archiveMutation}) => {
  const [selectedSpec, setSelectedSpec] = useState<number | null>(null);

  return (
    <>
      <ArchiveButton archiveMutation={archiveMutation} />
      <div className={cva("sm:grid grid-cols-2 flex flex-col-reverse h-full sm:border-t border-gray-400 mt-20", {
