    ...
    <div>
      ...
      <div>
        ...
        <p className="mt-4">
          ...
          арифметическое по{' '}
          {type === 'HARD' ? 'четырехбалльной' : 'пятибалльной'} шкале, где{' '}
          {type === 'HARD' ? '0' : '0'} - минимальный балл, {boundary} -
