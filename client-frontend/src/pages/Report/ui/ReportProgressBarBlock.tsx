  ...
  return (
    <>
      ...
      <p>
        ...
        арифметическое по {type === "HARD" ? "четырехбалльной" : "пятибалльной"}{" "}
        шкале, где 0 - минимальный балл, {boundary} - максимальный, н/о - не
        могу оценить. Шкала оценок экспертов (цвет цифр в таблицах соответствует
        шкале):
      </p>
      <div className="mt-[50px] flex gap-1">
        {type === "HARD" ? (
          ...
          <>
            <div
              style={{ width: `${(bars[0] / boundary) * 100}%` }}
              aria-hidden="true"
            >
              <div className="bg-gray-200 rounded-full overflow-hidden">
                <div className="h-2 bg-red-600 rounded-full w-full" />
            ...
            <div
              style={{ width: `${(bars[1] / boundary) * 100}%` }}
              aria-hidden="true"
            >
              <div className="bg-gray-200 rounded-full overflow-hidden">
                <div className="h-2 bg-indigo-600 rounded-full w-full" />
            ...
            <div
              style={{ width: `${(bars[2] / boundary) * 100}%` }}
              aria-hidden="true"
            >
              <div className="bg-gray-200 rounded-full overflow-hidden">
                <div className="h-2 bg-green-600 rounded-full w-full" />
